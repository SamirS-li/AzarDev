...
import home_banner from '../image/banner.webp'
      ...
      <div className="container">
        <div className="home-main">
          <div className="home-info">
            <h1 className='home-title'>Azar's Blogs</h1>
            <p className='home-text'>
              Discover Web Technologies! Explore the latest in web technology news and
              innovations with us. Don't miss our insights into the technologies
              shaping the future of the internet! Let's explore the web world together.
            ...
            <div className="sosial-media">
              ...
              <a href="https://github.com/AzarAhmadov" target="_blank" rel="noreferrer">
              ...
              <a href="https://www.linkedin.com/in/azar-ahmadov/" target="_blank" rel="noreferrer" >
                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><g id="LinkedIn">
                  <g>
              ...
              <a href="https://www.azarahmadov.com/" target="_blank" rel="noreferrer" >
                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
